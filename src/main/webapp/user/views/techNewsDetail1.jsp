...
<head>
    ...
    <title>Chi tiết bài báo: Heineken phát triển nhân tài công nghệ Việt Nam</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container my-4">
        <h1 class="mb-4">Heineken phát triển nhân tài công nghệ Việt Nam</h1>
        
        <div class="row mb-3">
            <div class="col-md-12">
                <img src="/SOF203_ASM/photo/tech1.jpg" class="img-fluid rounded mb-4" alt="Ảnh" style="max-width: 100%;">
            </div>
        </div>
        ...
        <div class="content">
            ...
            <p>
                Heineken không chỉ đóng góp vào sự phát triển của ngành công nghệ tại Việt Nam, mà còn đang từng bước khẳng định vai trò của mình như một nhà tuyển dụng hàng đầu trong lĩnh vực này. Điều này không chỉ giúp tăng cường sức cạnh tranh cho Heineken mà còn góp phần phát triển kinh tế và công nghệ của đất nước.
            </p>
        </div>

        <div class="mt-5">
            <a href="tech-news.html" class="btn btn-primary">Quay lại danh sách</a>
        </div>
    </div>
